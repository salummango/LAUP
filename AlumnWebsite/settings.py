"""
Django settings for AlumnWebsite project.
...
SECRET_KEY = 'django-insecure-0-v3jee39^9xzd=#$ghxp)-kayx(lx@(6+j+t0#(ks6ke$poeh'
...
ROOT_URLCONF = 'AlumnWebsite.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [r'''C:\Users\user\Documents\LAU\LAUPTEST2\templates'''],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'AlumnWebsite.wsgi.application'
